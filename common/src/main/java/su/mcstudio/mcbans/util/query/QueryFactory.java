...
public class QueryFactory {
    ...
    public QueryFactory(Supplier<ListeningExecutorService> executorServiceSupplier, Supplier<DataSource> dataSourceSupplier) {
        this.executorServiceSupplier = executorServiceSupplier;
        this.dataSourceSupplier = dataSourceSupplier;
    }

    public QueryFactory(Supplier<ListeningExecutorService> executorServiceSupplier, DataSource dataSource) {
        this.executorServiceSupplier = executorServiceSupplier;
    ...
    public ListenableAsyncQueryRunner listenableQuery() {
        return new ListenableAsyncQueryRunner(executorServiceSupplier.get(), new QueryRunner(getDataSource()));
    }

    public CompletableAsyncQueryRunner completableQuery() {
        return new CompletableAsyncQueryRunner(executorServiceSupplier.get(), new QueryRunner(getDataSource()));
    }
