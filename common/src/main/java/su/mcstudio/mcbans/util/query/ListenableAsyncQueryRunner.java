package su.mcstudio.mcbans.util.query;
...
public class ListenableAsyncQueryRunner extends AsyncQueryRunner {
    ...
    public ListenableAsyncQueryRunner(ListeningExecutorService executorService, QueryRunner queryRunner) {
    ...
    public <T> ListenableFuture<T> query(Connection conn, String sql, ResultSetHandler<T> rsh, Object... params) {
    ...
    public <T> ListenableFuture<T> insert(Connection conn, String sql, ResultSetHandler<T> rsh, Object... params) {
        return asFuture(() -> queryRunner.insert(conn, sql, rsh, params));
    }

    public <T> ListenableFuture<T> insertBatch(String sql, ResultSetHandler<T> rsh, Object[][] params) {
        return asFuture(() -> queryRunner.insertBatch(sql, rsh, params));
    }

    public <T> ListenableFuture<T> insertBatch(Connection conn, String sql, ResultSetHandler<T> rsh, Object[][] params) {
